...
<form id="fileUploadForm" action="{{route('event-image',$event_id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    <div class="row">
        <div class="col col-md-8 col-xl-8 card ">
            <!-- Input element to choose images -->
            <input name="images[]" type="file" id="select-image" accept="image/*" multiple>
            <label for="select-image" class="mb-4">
        ...
        <div class="preview_image mt-4">
            <!-- It will show the total number of files selected -->
            <p><span id="total-images">0</span> image(s) sélectionné</p>
    ...
    <div class="col col-md-4 col-xl-4">
        <a href="{{route('event-image-show',$event_id)}}" class="btn btn-secondary">retourner</a>
